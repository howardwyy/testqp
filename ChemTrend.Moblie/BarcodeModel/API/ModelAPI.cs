...
namespace BarcodeModel.API
{
    public class ModelAPI<T> : BaseAPI
    {
        ...
        public T GetModelByID(string ID, object model)
        {
            string html = this.SendRequest(this.ApiURL + "/" + ID, "GET",model);
        ...
        public void Delete(string id, object model)
        {
            this.SendRequest(this.ApiURL + "/" + id, "DELETE", model);
        }
    ...
    public class ModelAPI : BaseAPI
    {
        ...
        public Object GetModelByID(string ID, object model)
        {
            string html = this.SendRequest(this.ApiURL + "/" + ID, "GET", model);
