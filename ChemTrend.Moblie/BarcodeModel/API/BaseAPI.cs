...
namespace BarcodeModel.API
{
    public class BaseAPI
    {
        ...
        public string SendRequest(string url, string method, object model , params KeyValuePair<string, string>[] heads)
        {
            if (!this.TestConnect())
            {
        ...
        public static P DeserializeObject<P>(string json)
        {
            ...
            //替换所有null数据。
            //string strJson = json.Replace(":null", ":\"\"");
            JsonReader jr = new JsonReader(json);
            return JsonDeserializer.Deserialize<P>(jr);
        ...
        public static Object DeserializeObject(string json, Type type)
        {
            ...
            //string strJson = json.Replace(":null", ":\"\"");
            JsonReader jr = new JsonReader(json);
            return JsonDeserializer.Deserialize(jr, type);
        }
        ...
        //public static P DeserializeObject<P>(string json)
        //{
        //    return JsonMapper.ToObject<P>(json);
        //}
        //public static string SerializeObject(Object value)
        //{
        ...
        //public static Object DeserializeObject(string json, Type type)
        //{
        //    return null;//JsonMapper.ToJson(json, null);
        //    //return Newtonsoft.Json.JsonConvert.DeserializeObject(json, type);
        //}
    }
}
