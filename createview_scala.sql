...
as
SELECT RTRIM(MP65004) StockCode,RTRIM(SUM(MP65007)) PlanQty,RTRIM(CHA.SCUN003) Unit,SC01002+'-'+SC01003 StockName,MP65003,MP65042,MP65001,'32' Company FROM MP653200 
INNER JOIN SCUN3200 CHA ON CHA.SCUN001=MP65036 AND CHA.SCUN002='CHA' 
left join SC013200 sc on MP65004=sc.SC01001
group by MP65004,MP65007,SCUN003,SC01002,SC01003,MP65003,MP65001,MP65042
union all
SELECT RTRIM(MP65004) StockCode,RTRIM(SUM(MP65007)) PlanQty,RTRIM(CHA.SCUN003) Unit,SC01002+'-'+SC01003 StockName,MP65003,MP65042,MP65001,'31' Company FROM MP653100 
