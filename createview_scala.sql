...
create view view_WO
as
SELECT RTRIM(MP65004) StockCode,RTRIM(SUM(MP65007)) PlanQty,RTRIM(CHA.SCUN003) Unit,SC01002+'-'+SC01003 StockName,MP65003,MP65001,'02' Company FROM MP653200 
...
union all
SELECT RTRIM(MP65004) StockCode,RTRIM(SUM(MP65007)) PlanQty,RTRIM(CHA.SCUN003) Unit,SC01002+'-'+SC01003 StockName,MP65003,MP65001,'02' Company FROM MP653100 
